...
export class GeminiService {
        ...
        contents: {
          parts: [
            ...
            },
            {
              ...
              5. Generate the transcript in the primary language spoken in the audio.
              `
            }
          ]
        }
  ...
  startChat(transcript: string) {
    this.chatSession = this.ai.chats.create({
      model: 'gemini-2.5-flash',
      config: {
          systemInstruction: `You are BiliMind, an intelligent video knowledge assistant powered by Gemini.
          ...
          - Example: If the user asks in Chinese, reply in Chinese. If in English, reply in English.
